  ...
  return (
    <div className="h-[276.519px] relative shrink-0 w-[64.578px]" data-name="Qian_svg">
      <Wrapper1 additionalClassNames="inset-[-0.09%_-0.39%]">
        ...
        <path d={svgPaths.p3b8f5900} fill="var(--fill-0, #DDC6A2)" id="Vector_4" />
      </Wrapper1>
    </div>
  );
}
...
function QianSvg1() {
  return (
    <QianSvg7>
      ...
      <path d={svgPaths.p344e9a80} fill="var(--fill-0, #DDC6A2)" id="Vector_4" />
    </QianSvg7>
  );
}
...
function QianSvg2() {
  return (
    <QianSvg8>
      ...
      <path d={svgPaths.p19bf6f80} fill="var(--fill-0, #DDC6A2)" id="Vector_4" />
    </QianSvg8>
  );
}
...
function QianSvg3() {
  return (
    <QianSvg7>
      <path d={svgPaths.p2d159f00} fill="var(--fill-0, #F7E3BE)" id="Vector" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
      <path d={svgPaths.p9cd3c20} id="Vector_2" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
...
function QianSvg4() {
  return (
    <QianSvg8>
      <path d={svgPaths.p243db880} fill="var(--fill-0, #F7E3BE)" id="Vector" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
      <path d={svgPaths.p7422b70} id="Vector_2" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
  ...
  return (
    <div className="h-[277.337px] relative shrink-0 w-[64.539px]" data-name="Qian_svg">
      <Wrapper1 additionalClassNames="inset-[-0.09%_-0.39%_-0.09%_-0.4%]">
        <path d={svgPaths.p290d3500} fill="var(--fill-0, #F7E3BE)" id="Vector" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
        <path d={svgPaths.p37db080} id="Vector_2" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
    ...
    <div className="h-[277.897px] relative shrink-0 w-[73.755px]" data-name="Qian_svg">
      <div className="absolute inset-[-0.1%_-0.35%_-0.1%_-0.36%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 75 279">
          <g id="Qian_svg">
            <path d={svgPaths.p18e0f600} fill="var(--fill-0, #F7E3BE)" id="Vector" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
            <path d={svgPaths.pd00cf00} id="Vector_2" stroke="var(--stroke-0, #C1995F)" strokeMiterlimit="10" strokeWidth="0.504209" />
