import svgPaths from "./svg-gz900o72ab";
...
import imgDescriptionIllustrationPaianjiaojue from "@/assets/214fea0cefbd52f01d7b12d1ff4aa7fc0c07faa1.png";
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] bg-[#128f57] h-[15px] ml-[50px] mt-[85px] w-[208px]" />
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">拍案叫绝</p>
      </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`当一句话说中人心， `}</p>
        <p className="mb-0">回应往往是拍案叫绝。</p>
        <p> </p>
      </div>
    </div>
  );
    ...
    <div className="content-stretch flex flex-col gap-[24px] items-center leading-[0] relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center not-italic relative shrink-0 text-[#a1150c] text-[16px] text-center text-nowrap">
        ...
        <p className="leading-[normal]">
          <span className="font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] not-italic">“战略达人 -</span>
          <span>{` Brandin`}</span>
          <span className="font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] not-italic">g 免费咨</span>询1次”
        </p>
      </div>
    </div>
  );
...
function DescriptionContentPaianjiaojue() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_paianjiaojue">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationPaianjiaojue() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_paianjiaojue">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationPaianjiaojue} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#128f57] relative size-full" data-name="Description_拍案叫绝">
      <LandingBackgroundLayerGreen />
      <DescriptionContentPaianjiaojue />
      <DescriptionIllustrationPaianjiaojue />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
