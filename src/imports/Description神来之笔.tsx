import svgPaths from "./svg-u8s0kpv5bw";
...
import imgDescriptionIllustrationShenlaizhibi from "@/assets/85c0c3c62c885487e68af197080b2776ac61c02e.png";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">神来之笔</p>
      </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">关键之处，</p>
        <p className="mb-0">往往只差一笔。</p>
        <p>一笔到位，万事顺行。</p>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center leading-[0] relative shrink-0 w-full">
      <Frame6 />
      <div className="flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-end leading-[normal] not-italic relative shrink-0 text-[#a1150c] text-[16px] text-center text-nowrap">
...
function DescriptionContentShenlaizhibi() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_shenlaizhibi">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationShenlaizhibi() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_shenlaizhibi">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationShenlaizhibi} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#ff9a47] relative size-full" data-name="Description_神来之笔">
      <LandingBackgroundLayerGreen />
      <DescriptionContentShenlaizhibi />
      <DescriptionIllustrationShenlaizhibi />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
