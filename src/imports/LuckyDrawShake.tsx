...
const BG_PATTERN_CLIP0_SHAKE = 'clip0_bg_pattern_shake';
const BG_PATTERN_CLIP1_SHAKE = 'clip1_bg_pattern_shake';
    ...
    <div className="absolute inset-0 w-full h-full" data-name="LuckyDraw_BackgroundPatterns">
      <div className="absolute inset-0 w-full h-full">
        <svg className="block size-full" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 393 852" xmlns="http://www.w3.org/2000/svg">
          <g id="LuckyDraw_BackgroundPatterns" clipPath={`url(#${BG_PATTERN_CLIP0_SHAKE})`}>
          ...
          <g clipPath={`url(#${BG_PATTERN_CLIP1_SHAKE})`}>
          ...
          <defs>
            <clipPath id={BG_PATTERN_CLIP0_SHAKE}>
              <rect width="59.8127" height="207" fill="white" transform="translate(293 19)" />
            </clipPath>
            <clipPath id={BG_PATTERN_CLIP1_SHAKE}>
...
// SHAKE_SIGN_REPLACED: DOM 0 (第一排第2个) → LuckyDraw_Qian_Winner.svg，position 不变
function QianSvg() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 1 (上排中) → LuckyDraw_Qian6.svg，position 不变
function QianSvg1() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 2 (上排右) → LuckyDraw_Qian7.svg，position 不变
function QianSvg2() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 3 (下排左) → LuckyDraw_Qian1.svg，position 不变
function QianSvg3() {
  return (
    <div className="h-[277.802px] relative shrink-0 w-[83.912px]" data-name="Qian_svg">
...
// SHAKE_SIGN_REPLACED: DOM 4 (下排右) → LuckyDraw_Qian4.svg，position 不变
function QianSvg4() {
  return (
    <div className="h-[277.472px] relative shrink-0 w-[89.626px]" data-name="Qian_svg">
...
// SHAKE_SIGN_REPLACED: DOM 5 (上排左) → LuckyDraw_Qian_Winner.svg，position 不变
function QianSvg5() {
  return (
    <div className="h-[277.337px] relative shrink-0 w-[64.539px]" data-name="Qian_svg">
      <img src="/assets/qian/LuckyDraw_Qian_Winner.svg" alt="" className="block size-full object-contain" role="presentation" />
    </div>
  );
}
...
// SHAKE_SIGN_REPLACED: DOM 6 (下排第3) → LuckyDraw_Qian3.svg，position 不变
function QianSvg6() {
  return (
...
function LuckyDrawAllElementsSvg1({ isShaking = false, isWeChatLayout = false }: LuckyDrawAllElementsSvg1Props = {}) {
  return (
    <div 
      className={`absolute content-stretch flex items-center left-[69.45px] top-[315px] ${isShaking ? 'animate-bucket-sway' : ''}`}
...
const STAR_TWINKLE_CONFIG_SHAKE = [0, 1, 2, 3].map(() => ({
    ...
    <div className="h-[223px] relative shrink-0 w-[180.925px]" data-name="LuckyDraw_Stars_svg">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 181 223">
        <g id="LuckyDraw_Stars_svg">
          <path d={svgPaths.p2a1ea500} fill="var(--fill-0, #F9F9F9)" id="Vector" className={STAR_TWINKLE_CONFIG_SHAKE[0].scaleClass} style={{ animationDuration: STAR_TWINKLE_CONFIG_SHAKE[0].duration, animationDelay: STAR_TWINKLE_CONFIG_SHAKE[0].delay }} />
          <path d={svgPaths.p12c5e640} fill="var(--fill-0, #F9F9F9)" id="Vector_2" className={STAR_TWINKLE_CONFIG_SHAKE[1].scaleClass} style={{ animationDuration: STAR_TWINKLE_CONFIG_SHAKE[1].duration, animationDelay: STAR_TWINKLE_CONFIG_SHAKE[1].delay }} />
          <path d={svgPaths.p29e308f2} fill="var(--fill-0, #F9F9F9)" id="Vector_3" className={STAR_TWINKLE_CONFIG_SHAKE[2].scaleClass} style={{ animationDuration: STAR_TWINKLE_CONFIG_SHAKE[2].duration, animationDelay: STAR_TWINKLE_CONFIG_SHAKE[2].delay }} />
          <path d={svgPaths.p19446a80} fill="var(--fill-0, #F9F9F9)" id="Vector_4" className={STAR_TWINKLE_CONFIG_SHAKE[3].scaleClass} style={{ animationDuration: STAR_TWINKLE_CONFIG_SHAKE[3].duration, animationDelay: STAR_TWINKLE_CONFIG_SHAKE[3].delay }} />
        </g>
      </svg>
    </div>
  );
...
function Icon() {
  return (
    <div className="h-[33.01px] relative z-[999] shrink-0 w-[32.684px] animate-icon-shake" data-name="Icon">
...
export default function LuckyDrawShake({ onShakeClick, isShaking = false, isWeChatLayout = false, ctaDisabled = false }: LuckyDrawShakeProps) {
  ...
  return (
    <div className="relative size-full" data-name="LuckyDraw_Shake" style={{ background: 'linear-gradient(-180deg, #F95279 10%, #F55243 100%)' }}>
      ...
      {/* 签筒容器 - 添加摇动动画 */}
      <LuckyDrawAllElementsSvg1 isShaking={isShaking} isWeChatLayout={isWeChatLayout} />
