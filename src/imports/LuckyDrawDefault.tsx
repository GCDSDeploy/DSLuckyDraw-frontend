...
// DEFAULT_SIGN_REPLACED_2026: DOM 0 (上排中) → LuckyDraw_Qian6.svg
function QianSvg() {
  return (
...
// DEFAULT_SIGN_REPLACED_2026: DOM 1 (上排左) → LuckyDraw_Qian5.svg
function QianSvg1() {
  return (
...
// DEFAULT_SIGN_REPLACED_2026: DOM 2 (上排右) → LuckyDraw_Qian7.svg
function QianSvg2() {
  return (
...
// DEFAULT_SIGN_REPLACED_2026: DOM 3 (下排左) → LuckyDraw_Qian1.svg
function QianSvg3() {
  return (
    <div className="h-[277.802px] relative shrink-0 w-[83.912px]" data-name="Qian_svg">
...
// DEFAULT_SIGN_REPLACED_2026: DOM 4 (下排右) → LuckyDraw_Qian4.svg
function QianSvg4() {
  return (
    <div className="h-[277.472px] relative shrink-0 w-[89.626px]" data-name="Qian_svg">
...
// DEFAULT_SIGN_REPLACED_2026: DOM 5 (下排第2) → LuckyDraw_Qian2.svg
function QianSvg5() {
  return (
...
// DEFAULT_SIGN_REPLACED_2026: DOM 6 (下排第3) → LuckyDraw_Qian3.svg
function QianSvg6() {
  return (
...
function CallToAction() {
  return (
    <div className="flex flex-col items-center justify-center leading-[0] relative shrink-0" data-name="Call-to-action">
      <CallToActionText text="点击/摇摇" additionalClassNames="" />
      <CallToActionText text="得好礼" additionalClassNames="mt-1" />
    </div>
  );
}
