import svgPaths from "./svg-sy9qxbzyya";
...
import imgDescriptionIllustrationXinniankuaile from "@/assets/2441faf6134f905ea5daeb1444dff4d2e0c30ae6.png";
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid opacity-0 place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] bg-[#f7b635] h-[15px] ml-[50px] mt-[85px] w-[208px]" />
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">天时地利</p>
      </div>
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] justify-center leading-[normal] ml-[129px] mt-[42px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[258px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`所行皆明，所向皆顺。 `}</p>
        <p className="mb-0">{`新年快乐！ `}</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center leading-[0] relative shrink-0 w-full">
      <Frame6 />
      <div className="flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center not-italic relative shrink-0 text-[#a1150c] text-[22px] text-center text-nowrap">
        <p className="leading-[normal]">Happy New Year!</p>
      </div>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <LogoDsComponents />
      <p className="font-['Arial:Regular','Noto_Sans_JP:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#323232] text-[14px] text-nowrap" style={{ fontVariationSettings: "'wght' 400" }}>
        Design Studios 祝福
      </p>
    </div>
  );
...
function DescriptionContentXinniankuaile() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_xinniankuaile">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationXinniankuaile() {
  return (
    <div className="absolute h-[286px] left-[calc(50%+0.5px)] top-[158px] translate-x-[-50%] w-[340px]" data-name="Description Illustration_xinniankuaile">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationXinniankuaile} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#f7b635] relative size-full" data-name="Description_空签_新年快乐">
      <LandingBackgroundLayerGreen />
      <DescriptionContentXinniankuaile />
      <DescriptionIllustrationXinniankuaile />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
