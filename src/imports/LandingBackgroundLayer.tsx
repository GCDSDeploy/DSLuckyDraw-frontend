...
export default function LandingBackgroundLayer() {
  return (
    <div className="absolute content-stretch flex flex-col h-[852px] items-start left-0 overflow-clip p-[10px] top-0 w-full z-0" data-name="Landing_Background_Layer">
      <BackgroundSvg />
    </div>
  );
}