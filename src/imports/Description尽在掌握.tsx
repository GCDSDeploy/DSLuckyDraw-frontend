import svgPaths from "./svg-2igpn57pbo";
...
import imgDescriptionIllustrationJinzaihangwo from "@/assets/44c66d01332d3d761cc29554ff759cff4774a87a.png";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">尽在掌握</p>
      </div>
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`当数据被看懂， `}</p>
        <p className="mb-0">{`判断自然尽在掌握。 `}</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function DescriptionContentJinzaihangwo() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_jinzaihangwo">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationJinzaihangwo() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_jinzaihangwo">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationJinzaihangwo} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#cc2f3a] relative size-full" data-name="Description_尽在掌握">
      <LandingBackgroundLayerGreen />
      <DescriptionContentJinzaihangwo />
      <DescriptionIllustrationJinzaihangwo />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
