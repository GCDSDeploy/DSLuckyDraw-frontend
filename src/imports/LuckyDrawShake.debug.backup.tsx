...
// SHAKE_SIGN_REPLACED: DOM 0 (上排第3) → Default Qian7，position 不变
function QianSvg() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 1 (上排第1) → Default Qian5，position 不变
function QianSvg1() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 2 (下排第3) → Default Qian4，position 不变
function QianSvg2() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 3 (下排第1) → Default Qian1，position 不变
function QianSvg3() {
  return (
    <div className="h-[277.802px] relative shrink-0 w-[83.912px]" data-name="Qian_svg">
...
// SHAKE_SIGN_REPLACED: DOM 4 (下排第4) → Default Qian6，position 不变
function QianSvg4() {
  return (
    <div className="h-[277.472px] relative shrink-0 w-[89.626px]" data-name="Qian_svg">
...
// SHAKE_SIGN_REPLACED: DOM 5 (第一排第2个) → LuckyDraw_Qian_Winner.svg，position 不变
function QianSvg5() {
  return (
...
// SHAKE_SIGN_REPLACED: DOM 6 (下排第2) → Default Qian3，position 不变
function QianSvg6() {
  return (
