import svgPaths from "./svg-lo0sjzpknb";
...
import imgDescriptionIllustrationTianshidili from "@/assets/470a967e93f4d5cd508180f51a41e59a83be56e0.png";
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_KR:Bold','Noto_Sans_SC:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`在对的时点， `}</p>
        <p className="mb-0">用对的方式验证想法。</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <LogoDsComponents />
      <p className="font-['Arial:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#323232] text-[14px] text-nowrap" style={{ fontVariationSettings: "'wght' 400" }}>
        Design Studios 原型设计
      </p>
    </div>
  );
...
function DescriptionContentTianshidili() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_tianshidili">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationTianshidili() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_tianshidili">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationTianshidili} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#f7b635] relative size-full" data-name="Description_天时地利">
      <LandingBackgroundLayerGreen />
      <DescriptionContentTianshidili />
      <DescriptionIllustrationTianshidili />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
