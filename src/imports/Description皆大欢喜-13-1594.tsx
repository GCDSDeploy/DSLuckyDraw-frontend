import svgPaths from "./svg-noik7dcgub";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`各抒其见，终归同向。 `}</p>
        <p className="mb-0">共识落定，皆大欢喜。</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
    ...
    <div className="h-[27px] relative shrink-0 w-[28px]" data-name="LOGO_DS COMPONENTS*">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 27">
        <g id="LOGO_DS COMPONENTS*">
          <path d={svgPaths.p237a4d00} fill="url(#paint0_linear_13_1139)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_13_1139" x1="4.53568e-10" x2="27.9407" y1="4.43833e-10" y2="4.4383e-10">
...
function DescriptionContentJiedahuanxi() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_jiedahuanxi">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationJiedahuanxi() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_jiedahuanxi">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationJiedahuanxi} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#128f57] relative size-full" data-name="Description_皆大欢喜">
      <LandingBackgroundLayerGreen />
      <DescriptionContentJiedahuanxi />
      <DescriptionIllustrationJiedahuanxi />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
