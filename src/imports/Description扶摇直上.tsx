import svgPaths from "./svg-rppszns1z8";
...
import imgDescriptionIllustrationFuyaozhishang from "@/assets/c415786c7eab0bd63f9f60b113d4e4b27d76e242.png";
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] bg-[#ff9a47] h-[15px] ml-[50px] mt-[85px] w-[208px]" />
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">扶摇直上</p>
      </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">新年问事，</p>
        <p className="mb-0">{`多半求一个“明白”。 `}</p>
        <p>{`事一旦看懂，路自然顺了。 `}</p>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <LogoDsComponents />
      <p className="font-['Arial:Regular','Noto_Sans_SC:Regular','Noto_Sans_KR:Regular','Noto_Sans_JP:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#323232] text-[14px] w-[180px]" style={{ fontVariationSettings: "'wght' 400" }}>
        Design Studios 创意视频，加速战略阐述
      </p>
    </div>
  );
}
...
function DescriptionContentFuyaozhishang() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_fuyaozhishang">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationFuyaozhishang() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_fuyaozhishang">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationFuyaozhishang} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#ff9a47] relative size-full" data-name="Description_扶摇直上">
      <LandingBackgroundLayerGreen />
      {[...Array(2).keys()].map((_, i) => (
        <DescriptionContentFuyaozhishang key={i} />
      ))}
      <DescriptionIllustrationFuyaozhishang />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
