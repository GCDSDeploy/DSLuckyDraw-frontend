import svgPaths from "./svg-es8vtirbsx";
...
import imgDescriptionIllustrationYigaoguo from "@/assets/9700880dd7e09807c3a6ab21a7b7c68fbadeffe1.png";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">一稿过</p>
      </div>
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold','Noto_Sans_KR:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`方向清晰，创意对位。 `}</p>
        <p className="mb-0">{`第一版，便是一稿过。 `}</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center leading-[0] relative shrink-0 w-full">
      <Frame6 />
      <div className="flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center not-italic relative shrink-0 text-[#a1150c] text-[16px] text-center text-nowrap">
        <p className="leading-[normal] mb-0">Happy New Year! 查收奖励👇</p>
        <p className="leading-[normal]">
          <span className="font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] not-italic">“战略达人 - Digital 免费咨</span>询1次”
        </p>
      </div>
    </div>
  );
...
function DescriptionContentYigaoguo() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_yigaoguo">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationYigaoguo() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_yigaoguo">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationYigaoguo} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#f7b635] relative size-full" data-name="Description_一稿过">
      <LandingBackgroundLayerGreen />
      <DescriptionContentYigaoguo />
      <DescriptionIllustrationYigaoguo />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
