import svgPaths from "./svg-nucu4ebjm6";
...
import imgDescriptionIllustrationWenbutuijin from "@/assets/4906f0f3202aad8b36b08038263a94644c549d9a.png";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] flex flex-col font-['zihun151hao-lianmengzongyiti:Regular',sans-serif] justify-center leading-[0] ml-[151px] mt-[60.5px] not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[normal]">稳步推进</p>
      </div>
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] flex flex-col font-['Arial:Bold','Noto_Sans_SC:Bold','Noto_Sans_JP:Bold','Noto_Sans_KR:Bold',sans-serif] justify-center leading-[1.25] ml-[147px] mt-[45px] relative text-[#323232] text-[24px] text-center translate-x-[-50%] translate-y-[-50%] w-[294px]" style={{ fontVariationSettings: "'wght' 700" }}>
        <p className="mb-0">{`层次分明，路径清晰。 `}</p>
        <p className="mb-0">{`表达所至，稳步推进。 `}</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function DescriptionContentWenbutuijin() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[468px] items-end justify-center left-[calc(50%+0.5px)] overflow-clip p-[18px] top-[270px] translate-x-[-50%] w-[338px]" data-name="Description_Content_wenbutuijin">
      <Group />
      <Frame2 />
...
function DescriptionIllustrationWenbutuijin() {
  return (
    <div className="absolute h-[210px] left-[calc(50%+0.5px)] top-[130px] translate-x-[-50%] w-[300px]" data-name="Description Illustration_wenbutuijin">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDescriptionIllustrationWenbutuijin} />
    </div>
  );
}
...
export default function Description() {
  return (
    <div className="bg-[#5282ea] relative size-full" data-name="Description_稳步推进">
      <LandingBackgroundLayerGreen />
      <DescriptionContentWenbutuijin />
      <DescriptionIllustrationWenbutuijin />
      <DescriptionButtons />
      <DescriptionBack />
      <DescriptionGiftPool />
    </div>
